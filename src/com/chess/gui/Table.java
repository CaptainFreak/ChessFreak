...
public class Table {
	...
	private static String defaultPieceImagesPath="/home/captainfreak/workspace/ChessFreak/src/com/chess/gui/img/";
	
	private final Color lightTileColor=Color.decode("#FFFACD");
	private final Color darkTileColor=Color.decode("#593E2A");
	

	public Table(){
		this.gameFrame=new JFrame("ChessFreak by CaptainFreak");
